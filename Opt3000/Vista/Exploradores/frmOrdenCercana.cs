...
{
    public partial class frmOrdenCercana : Form
    {
        public string numliq;
        public bool abrir = false;
        string reimprimirOrden;
        bool modelo = true;
        public frmOrdenCercana()
        {
            InitializeComponent();
        ...
        private void gridView1_DoubleClick(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    OrdenVisionCerca frm = new OrdenVisionCerca(Convert.ToInt64(numliq), reimprimirOrden, modelo);
        ...
        {
            gridControl1.DataSource = ExploradorController.OrdenCerca(dtpDesde.DateTime, dtpHasta.DateTime);
